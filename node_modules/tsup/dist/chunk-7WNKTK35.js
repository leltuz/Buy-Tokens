...
var loadJson = async (filepath) => {
  try {
    return _chunkMTFH44DAjs.jsoncParse.call(void 0, await _fs2.default.promises.readFile(filepath, "utf8"));
  } catch (error) {
...
var colorize = (type, data, onlyImportant = false) => {
  ...
  return _chunkXGMM5K5Rjs.colorette_exports[color](data);
};
var makeLabel = (name, input, type) => {
  return [
    name && `${_chunkXGMM5K5Rjs.dim.call(void 0, "[")}${name.toUpperCase()}${_chunkXGMM5K5Rjs.dim.call(void 0, "]")}`,
...
var reportSize = (logger, format, files) => {
  ...
  for (const name of filenames) {
    logger.success(
      format,
      `${_chunkXGMM5K5Rjs.bold.call(void 0, padRight(name, maxLength))}${_chunkXGMM5K5Rjs.green.call(void 0, 
